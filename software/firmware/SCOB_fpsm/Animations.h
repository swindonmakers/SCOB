...
ANIMATION tapFoot {
  ...
  new unsigned long[7]{1000, 300, 1000, 300, 1000, 300, 1000}
};
...
ANIMATION anims[MAX_ANIM_CMD] = { stand, walkForward, turnLeft, turnRight, footTap, tipToes, lookLeft, lookRight, tapFoot };
