...
HCSR04UltrasonicSensor_Con_TXCan  = [[44.5/2-26/2, 10, 1], [0,0,1], 0,0,0];
HCSR04UltrasonicSensor_Con_RXCan  = [[44.5/2+26/2, 10, 1], [0,0,1], 0,0,0];
...
module HCSR04UltrasonicSensor() {
    ...
    if (DebugConnectors) {
        ...
        connector(HCSR04UltrasonicSensor_Con_TXCan);
        connector(HCSR04UltrasonicSensor_Con_RXCan);
    }
